...
def run():
    ...
    curvature = np.loadtxt('model/RA.curv.dat') #load the curvature data of each points
    ...
    # Save coordinates of points that on detected on the biggest ring
    ...
    source = mlab.pipeline.open('model/RA.vtk') #Open the source
