...
def run(args):
    ...
    fname = glob('{}*.vtx'.format(args.mesh))
    ...
    for r in rings:
        ...
        fname = '{}_{}.vtx'.format(args.mesh,r.name)
    ...
    writer.SetFileName('{}_boundaries_tagged.vtk'.format(args.mesh))
    writer.Write()
