...
def run():
    ...
    reader.SetFileName('result/la_endo_surface.vtk')
    reader.Update()
    ...
    file_write_obj = open("data/la_ring_edge_points_id.txt", 'w')
    ...
    print('Writing the endo surface without rings as la_endo_without_rings_surface.vtk...')
    meshNew = dsa.WrapDataObject(new_endo)
    writer = vtk.vtkUnstructuredGridWriter()
    writer.SetFileName("result/la_endo_without_rings_surface.vtk")
    writer.SetInputData(meshNew.VTKObject)
    writer.Write()
    print('Writing the endo surface without rings as la_endo_without_rings_surface.vtk...done\n ')
    print('Writing the rings as rings.vtk...')

    meshNew = dsa.WrapDataObject(extraction)
    writer = vtk.vtkUnstructuredGridWriter()
    writer.SetFileName("result/la_rings.vtk")
    writer.SetInputData(meshNew.VTKObject)
    writer.Write()
    print('Writing the rings as la_rings.vtk...done\n')
