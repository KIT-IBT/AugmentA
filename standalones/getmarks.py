...
def get_landmarks(mesh, prealigned=1, scale=1):
    ...
    mv_band = function.cut_a_band_from_model(function.to_polydata(mv_anterior), center_mv, center_rpv, center_lpv, 10*scale)
    ...
    lpv_base_temp = function.multidim_intersect(vtk.util.numpy_support.vtk_to_numpy(band.GetPoints().GetData()), lpv_path)
    rpv_base_temp = function.multidim_intersect(vtk.util.numpy_support.vtk_to_numpy(band.GetPoints().GetData()), rpv_path)
    
    lpv_base_fuzzy = np.asarray([np.mean(lpv_base_temp[:, 0]), np.mean(lpv_base_temp[:, 1]), np.mean(lpv_base_temp[:, 2])])
    rpv_base_fuzzy = np.asarray([np.mean(rpv_base_temp[:, 0]), np.mean(rpv_base_temp[:, 1]), np.mean(rpv_base_temp[:, 2])])
    ...
    p1_mv_sep_50_path = function.dijkstra_path(model_polydata, function.get_closest_point_id_from_polydata(model_polydata, p1_mv_50), function.get_closest_point_id_from_polydata(model_polydata, sep_50))

    p1_mv_sep_50 = p1_mv_sep_50_path[int(len(p1_mv_sep_50_path)*0.5)]
    
    p1_mv_sep_75_path = function.dijkstra_path(model_polydata, function.get_closest_point_id_from_polydata(model_polydata, p1_mv_75), function.get_closest_point_id_from_polydata(model_polydata, sep_25))
    
    p1_mv_sep_75 = p1_mv_sep_75_path[int(len(p1_mv_sep_75_path)*0.5)]
    
    p2_mv_sep_50_path = function.dijkstra_path(model_polydata, function.get_closest_point_id_from_polydata(model_polydata, p2_mv_33), function.get_closest_point_id_from_polydata(model_polydata, sep_50))
    
    p2_mv_sep_50 = p2_mv_sep_50_path[int(len(p2_mv_sep_50_path)*0.5)]
    
    p2_mv_sep_75_path = function.dijkstra_path(model_polydata, function.get_closest_point_id_from_polydata(model_polydata, p2_mv_66), function.get_closest_point_id_from_polydata(model_polydata, sep_25))
    
    p2_mv_sep_75 = p2_mv_sep_75_path[int(len(p2_mv_sep_75_path)*0.5)]

    # Extra pts:
    rspvo_p1_mv_50_path = function.dijkstra_path(model_polydata, function.get_closest_point_id_from_polydata(model_polydata, rs_o), function.get_closest_point_id_from_polydata(model_polydata, p1_mv_50))
    ...
    rspvo_p1_mv_sep_50_path = function.dijkstra_path(model_polydata, function.get_closest_point_id_from_polydata(model_polydata, rs_o), function.get_closest_point_id_from_polydata(model_polydata, p1_mv_sep_50))
    ...
    name_lst = ['lspv_o', 'lspv_i', 'lipv_i', 'lipv_o', 'rspv_o', 'rspv_i', 'ripv_i', 'ripv_o', 
                ...
                'rspvo_p1_mv_30','rspvo_p1_mv_50','rspvo_p1_mv_70', 'rspvo_p1_mv_sep_30','rspvo_p1_mv_sep_50','rspvo_p1_mv_sep_70',
